 ...
 * @author jiangxihao
 */
public abstract class AbstractGhost extends AbstractUnit {
    /**
     ...
     */
    protected AbstractGhost(Map<Direction, Sprite> spriteMap, int moveInterval, int intervalVariation) {
    ...
    protected Direction randomMove() {
        AbstractSquare abstractSquare = getAbstractSquare();
        List<Direction> directions = new ArrayList<>();
        for (Direction direction : Direction.values()) {
            if (abstractSquare.getSquareAt(direction).isAccessibleTo(this)) {
