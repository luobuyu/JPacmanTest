...
public abstract class AbstractSquare {
     ...
     */
    private final List<AbstractUnit> occupants;

    /**
     * The collection of squares adjacent to this square.
     */
    private final Map<Direction, AbstractSquare> neighbours;

    /**
     * Creates a new, empty square.
     */
    protected AbstractSquare() {
     ...
     */
    public AbstractSquare getSquareAt(Direction direction) {
     ...
     */
    public void link(AbstractSquare neighbour, Direction direction) {
     ...
     *         which they occupied this square (i.e. oldest first.)
     */
    public List<AbstractUnit> getOccupants() {
     ...
     */
    void put(AbstractUnit occupant) {
     ...
     */
    void remove(AbstractUnit occupant) {
        assert occupant != null;
     ...
     */
    protected final boolean invariant(AbstractSquare this) {
        for (AbstractUnit occupant : occupants) {
            if (occupant.hasSquare() && occupant.getAbstractSquare() != this) {
                return false;
            }
        }
        return true;
     ...
     */
    public abstract boolean isAccessibleTo(AbstractUnit abstractUnit);
